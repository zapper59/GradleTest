...
set CLASSPATH=%APP_HOME%\lib\GradleTest.jar;%APP_HOME%\lib\libs-1

@rem Execute GradleTest
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %GRADLE_TEST_OPTS%  -classpath "%CLASSPATH%" GradleTest %CMD_LINE_ARGS%
